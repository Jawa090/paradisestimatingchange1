...
const Footer = () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="h-10 w-10 bg-gold rounded-full flex items-center justify-center mr-2">
                <span className="text-white font-bold text-xl">PE</span>
              </div>
              <span className="text-xl font-poppins font-bold">Paradise Estimating</span>
            </div>
            <p className="text-gray-300 mb-4">
              Professional construction estimating services for contractors, builders, and developers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/privacy-policy" className="text-gray-300 hover:text-gold transition-colors">Privacy Policy</Link>
              </li>
            </ul>
          </div>
  ...
  <ul className="space-y-2">
    <li className="flex items-start">
      <svg
        className="w-5 h-5 mt-1 mr-2 text-gold"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      ...
      <span className="text-gray-300">896 Bay Ridge Avenue,<br />New York, NY 11220, United States</span>
    </li>
    <li className="flex items-start">
      <svg
        className="w-5 h-5 mt-1 mr-2 text-gold"
      ...
      <span className="text-gray-300">4215 Lunar Way,<br />Union City, CA, United States</span>
    </li>
    <li className="flex items-start">
      <svg
        className="w-5 h-5 mt-1 mr-2 text-gold"
      ...
      <span className="text-gray-300">150 Consumers Road, Suite 502,<br />North York, ON M2J 1P9, Canada</span>
    </li>
    <li className="flex items-start">
      <svg
        className="w-5 h-5 mt-1 mr-2 text-gold"
      ...
      <span className="text-gray-300">Office Number 312, Muhammad Al Mulla Tower,<br />8 Al-Etihad Street, Sharjah, UAE</span>
    </li>
    <li className="flex items-start">
      <svg
        className="w-5 h-5 mt-1 mr-2 text-gold"
      ...
      <span className="text-gray-300">760 B PCSIR II,<br />Lahore, Pakistan</span>
    </li>
